      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-start" style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
            <div className="flex items-center justify-start" style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
              ...
              <div className="flex flex-col ml-3" style={{ display: 'flex', flexDirection: 'column', marginLeft: '0.75rem' }}>
                <span className={`text-2xl font-black font-sans flex items-center text-[#2563eb] whitespace-nowrap leading-relaxed pb-1`} style={{ fontSize: '1.5rem', fontWeight: 900, display: 'flex', alignItems: 'center', color: '#2563eb', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>
                  VidyaNation
                </span>
                <span className={`text-[10px] font-bold font-sans text-[#94a3b8] uppercase mt-0.5 whitespace-nowrap leading-relaxed pb-1`} style={{ fontSize: '10px', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', marginTop: '0.125rem', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>The Future of local education</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 flex items-center justify-end pr-4" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', paddingRight: '1rem' }}>
            ...
            <h1 className={`text-2xl font-black font-sans text-[#1e293b] uppercase max-w-[200px] leading-relaxed text-right whitespace-nowrap pb-1`} style={{ fontSize: '1.5rem', fontWeight: 900, color: '#1e293b', textTransform: 'uppercase', maxWidth: '200px', lineHeight: 1.5, textAlign: 'right', whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>
              {instituteName}
            </h1>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-row px-10 py-8 justify-between items-stretch" style={{ flex: 1, display: 'flex', flexDirection: 'row', padding: '2rem 2.5rem', justifyContent: 'space-between', alignItems: 'stretch', boxSizing: 'border-box' }}>
          ...
          <div className="flex flex-col w-[30%]" style={{ display: 'flex', flexDirection: 'column', width: '30%' }}>
            <h3 className="text-sm font-black font-sans text-[#94a3b8] uppercase border-b border-[#f1f5f9] pb-2 mb-6 leading-relaxed" style={{ fontSize: '0.875rem', fontWeight: 900, color: '#94a3b8', textTransform: 'uppercase', borderBottom: '1px solid #f1f5f9', paddingBottom: '0.5rem', marginBottom: '1.5rem', whiteSpace: 'nowrap', lineHeight: 1.5 }}>Student Details</h3>
            <div className="flex flex-col" style={{ display: 'flex', flexDirection: 'column' }}>
              <div className="mb-4" style={{ marginBottom: '1rem' }}>
                <p className="text-xs font-bold font-sans text-[#94a3b8] uppercase leading-relaxed mb-1.5 whitespace-nowrap pb-1" style={{ fontSize: '0.75rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', lineHeight: 1.5, marginBottom: '0.375rem', whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>Full Name</p>
                <p className="text-xl font-black font-sans text-[#0f172a] leading-relaxed max-w-[150px] whitespace-nowrap pb-1" style={{ fontSize: '1.25rem', fontWeight: 900, color: '#0f172a', lineHeight: 1.5, maxWidth: '150px', whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>{studentName}</p>
              </div>
              <div className="flex items-center mb-4" style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                ...
                <span className="text-[13px] font-medium font-sans text-[#475569] ml-2 max-w-[150px] leading-relaxed whitespace-nowrap pb-1" style={{ fontSize: '13px', fontWeight: 500, color: '#475569', marginLeft: '0.5rem', maxWidth: '150px', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>{studentPhone || 'N/A'}</span>
              </div>
              {studentEmail && (
                <div className="flex items-start mb-4" style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '1rem' }}>
                  ...
                  <span className="text-[12px] font-medium font-sans text-[#475569] leading-relaxed ml-2 max-w-[150px] whitespace-nowrap pb-1" style={{ fontSize: '12px', fontWeight: 500, color: '#475569', lineHeight: 1.5, marginLeft: '0.5rem', maxWidth: '150px', whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>{studentEmail}</span>
                </div>
              )}
              {dob ? (
                <div className="flex items-center mb-4" style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  <User size={14} className="text-[#2563eb]" style={{ color: '#2563eb' }} />
                  <span className="text-[13px] font-medium font-sans text-[#475569] ml-2 max-w-[150px] leading-relaxed whitespace-nowrap pb-1" style={{ fontSize: '13px', fontWeight: 500, color: '#475569', marginLeft: '0.5rem', maxWidth: '150px', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>DOB: {dob}</span>
                </div>
              ) : age ? (
                <div className="flex items-center mb-4" style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  <User size={14} className="text-[#2563eb]" style={{ color: '#2563eb' }} />
                  <span className="text-[13px] font-medium font-sans text-[#475569] ml-2 max-w-[150px] leading-relaxed whitespace-nowrap pb-1" style={{ fontSize: '13px', fontWeight: 500, color: '#475569', marginLeft: '0.5rem', maxWidth: '150px', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>{age} Years Old</span>
                </div>
              ) : null}
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between h-full w-[30%]" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%', width: '30%' }}>
            <div>
              <h3 className="text-sm font-black font-sans text-[#94a3b8] uppercase border-b border-[#f1f5f9] pb-2 mb-4 leading-relaxed" style={{ fontSize: '0.875rem', fontWeight: 900, color: '#94a3b8', textTransform: 'uppercase', borderBottom: '1px solid #f1f5f9', paddingBottom: '0.5rem', marginBottom: '1rem', whiteSpace: 'nowrap', lineHeight: 1.5 }}>Batch Details</h3>
              <div className="flex flex-col" style={{ display: 'flex', flexDirection: 'column' }}>
                <div className="mb-4" style={{ marginBottom: '1rem' }}>
                  <p className="text-xs font-bold font-sans text-[#94a3b8] uppercase leading-relaxed mb-1.5 whitespace-nowrap pb-1" style={{ fontSize: '0.75rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', lineHeight: 1.5, marginBottom: '0.375rem', whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>Batch Name</p>
                  <p className="text-lg font-black font-sans text-[#0f172a] leading-relaxed max-w-[150px] whitespace-nowrap pb-1" style={{ fontSize: '1.125rem', fontWeight: 900, color: '#0f172a', lineHeight: 1.5, maxWidth: '150px', whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>{batchName}</p>
                </div>
                {teacherName && (
                  <div className="mb-4" style={{ marginBottom: '1rem' }}>
                    <p className="text-xs font-bold font-sans text-[#94a3b8] uppercase leading-relaxed mb-1.5 whitespace-nowrap pb-1" style={{ fontSize: '0.75rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', lineHeight: 1.5, marginBottom: '0.375rem', whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>Teacher</p>
                    <p className="text-[13px] font-black font-sans text-[#334155] leading-relaxed max-w-[150px] whitespace-nowrap pb-1" style={{ fontSize: '13px', fontWeight: 900, color: '#334155', lineHeight: 1.5, maxWidth: '150px', whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>{teacherName}</p>
                  </div>
                )}
                <div className="flex items-center mb-4" style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  <Hash size={14} className="text-[#2563eb] shrink-0" style={{ color: '#2563eb', flexShrink: 0 }} />
                  <span className="text-[12px] font-bold font-sans text-[#334155] bg-[#f8fafc] border border-[#e2e8f0] px-2 py-1 rounded-md ml-2 max-w-[150px] leading-relaxed whitespace-nowrap pb-1" style={{ fontSize: '12px', fontWeight: 700, color: '#334155', backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', padding: '0.25rem 0.5rem', borderRadius: '0.375rem', marginLeft: '0.5rem', maxWidth: '150px', lineHeight: 1.5, whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>{paymentId}</span>
                </div>
                <div className="flex items-center mb-4" style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  <Calendar size={14} className="text-[#2563eb]" style={{ color: '#2563eb' }} />
                  <span className="text-[13px] font-medium font-sans text-[#475569] ml-2 whitespace-nowrap leading-relaxed pb-1" style={{ fontSize: '13px', fontWeight: 500, color: '#475569', marginLeft: '0.5rem', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>Issued: <span className="font-bold font-sans text-[#0f172a] whitespace-nowrap" style={{ fontWeight: 700, color: '#0f172a', whiteSpace: 'nowrap' }}>{enrollmentDate}</span></span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-end justify-between pt-4 relative mt-auto" style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', paddingTop: '1rem', position: 'relative', marginTop: 'auto' }}>
              <div className="relative pb-2 pr-2 ml-auto w-[80px]" style={{ position: 'relative', paddingBottom: '0.5rem', paddingRight: '0.5rem', marginLeft: 'auto', width: '80px' }}>
                ...
                <p className="text-[8px] font-black font-sans text-[#94a3b8] uppercase text-center mt-2 absolute -bottom-2 -left-2 w-[100px] leading-relaxed pb-1" style={{ fontSize: '8px', fontWeight: 900, color: '#94a3b8', textTransform: 'uppercase', textAlign: 'center', marginTop: '0.5rem', position: 'absolute', bottom: '-0.5rem', left: '-0.5rem', width: '100px', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>Authorized</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="h-16 bg-[#f8fafc] border-t border-[#f1f5f9] flex items-center justify-center px-16" style={{ height: '4rem', backgroundColor: '#f8fafc', borderTop: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 4rem', boxSizing: 'border-box' }}>
          <div className="flex flex-col items-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <span className="text-sm font-bold font-sans text-[#334155] uppercase whitespace-nowrap leading-relaxed pb-1" style={{ fontSize: '0.875rem', fontWeight: 700, color: '#334155', textTransform: 'uppercase', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>vidyanation.online</span>
            <span className="text-[10px] font-semibold font-sans text-[#94a3b8] uppercase mt-0.5 whitespace-nowrap leading-relaxed pb-1" style={{ fontSize: '10px', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', marginTop: '0.125rem', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>Verified Student Asset</span>
          </div>
        </div>
    ...
    >
      <div className="flex-1 flex flex-row items-center justify-center p-12" style={{ flex: 1, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: '3rem', position: 'relative', zIndex: 10 }}>
        <div className="flex flex-col items-center justify-center text-center mr-16" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', marginRight: '4rem' }}>
          ...
          <h1 className="text-5xl font-black font-sans text-[#0f172a] mb-3 whitespace-nowrap leading-relaxed pb-1" style={{ fontSize: '3rem', fontWeight: 900, color: '#0f172a', marginBottom: '0.75rem', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>
            VidyaNation
          </h1>
          
          <p className="text-xl font-bold font-sans text-[#1e293b] opacity-80 uppercase whitespace-nowrap leading-relaxed pb-1" style={{ fontSize: '1.25rem', fontWeight: 700, color: '#1e293b', opacity: 0.8, textTransform: 'uppercase', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>
        ...
        {paymentId && (
          <div className="flex flex-col items-center justify-center p-6 rounded-2xl backdrop-blur-sm border shadow-xl" style={{ backgroundColor: 'rgba(255, 255, 255, 0.4)', borderColor: 'rgba(255, 255, 255, 0.5)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '1.5rem', borderRadius: '1rem', border: '1px solid rgba(255, 255, 255, 0.5)', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)' }}>
            ...
            <div className="text-center" style={{ textAlign: 'center' }}>
              <p className="text-sm font-black font-sans text-[#0f172a] uppercase leading-relaxed whitespace-nowrap pb-1" style={{ fontSize: '0.875rem', fontWeight: 900, color: '#0f172a', textTransform: 'uppercase', lineHeight: 1.5, whiteSpace: 'nowrap', paddingBottom: '0.25rem' }}>Verify Student</p>
              <p className="text-xs font-medium font-sans text-[#475569] mt-1 whitespace-nowrap leading-relaxed pb-1" style={{ fontSize: '0.75rem', fontWeight: 500, color: '#475569', marginTop: '0.25rem', whiteSpace: 'nowrap', lineHeight: 1.5, paddingBottom: '0.25rem' }}>Scan QR Code</p>
            </div>
          </div>
        )}
      ...
      >
         <span className="text-sm font-black font-sans uppercase whitespace-nowrap leading-relaxed pb-1" style={{ fontSize: '0.875rem', fontWeight: 900, textTransform: 'uppercase', whiteSpace: 'nowrap', color: 'rgba(15, 23, 42, 0.4)', lineHeight: 1.5, paddingBottom: '0.25rem' }}>Verified Institution Asset</span>
      </div>
    </div>
  );
});
