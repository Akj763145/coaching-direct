          ...
          <div className="flex flex-col w-[30%]" style={{ display: 'flex', flexDirection: 'column', width: '30%' }}>
            ...
            <div className="flex flex-col" style={{ display: 'flex', flexDirection: 'column' }}>
              <div className="mb-4" style={{ marginBottom: '1rem' }}>
                ...
                <p className="text-xl font-black text-[#0f172a] leading-relaxed max-w-[150px] whitespace-nowrap font-sans pb-1 capitalize" style={{ fontSize: '1.25rem', fontWeight: 900, color: '#0f172a', lineHeight: 1.625, maxWidth: '150px', whiteSpace: 'nowrap', textTransform: 'capitalize' }}>{studentName}</p>
              </div>
              ...
              {dob ? (
                <div className="flex items-center mb-4" style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  ...
                  <span className="text-[13px] font-medium text-[#1e293b] ml-2 max-w-[150px] whitespace-nowrap font-sans leading-relaxed pb-1" style={{ fontSize: '13px', fontWeight: 500, color: '#1e293b', marginLeft: '0.5rem', maxWidth: '150px', lineHeight: 1.625, whiteSpace: 'nowrap' }}>DOB: {dob}</span>
                </div>
              ) : age ? (
                <div className="flex items-center mb-4" style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  <User size={14} className="text-[#2563eb]" style={{ color: '#2563eb' }} />
                  <span className="text-[13px] font-medium text-[#1e293b] ml-2 max-w-[150px] whitespace-nowrap font-sans leading-relaxed pb-1" style={{ fontSize: '13px', fontWeight: 500, color: '#1e293b', marginLeft: '0.5rem', maxWidth: '150px', lineHeight: 1.625, whiteSpace: 'nowrap' }}>{age} Years Old</span>
                </div>
              ) : null}
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between h-full w-[30%]" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%', width: '30%' }}>
            <div>
              ...
              <div className="flex flex-col" style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                {teacherName && (
                  <div className="mb-4" style={{ marginBottom: '1rem' }}>
                    <p className="text-xs font-bold text-[#64748b] uppercase leading-relaxed mb-1.5 whitespace-nowrap font-sans pb-1" style={{ fontSize: '0.75rem', fontWeight: 700, color: '#64748b', textTransform: 'uppercase', lineHeight: 1.625, marginBottom: '0.375rem', whiteSpace: 'nowrap' }}>Teacher</p>
                    <p className="text-[13px] font-black text-[#334155] leading-relaxed max-w-[150px] whitespace-nowrap font-sans pb-1 capitalize" style={{ fontSize: '13px', fontWeight: 900, color: '#334155', lineHeight: 1.625, maxWidth: '150px', whiteSpace: 'nowrap', textTransform: 'capitalize' }}>{teacherName}</p>
                  </div>
                )}
                <div className="flex items-center mb-4" style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                ...
                <div className="flex items-center mb-4" style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  ...
                  <span className="text-[13px] font-medium text-[#1e293b] ml-2 whitespace-nowrap font-sans leading-relaxed pb-1" style={{ fontSize: '13px', fontWeight: 500, color: '#1e293b', marginLeft: '0.5rem', whiteSpace: 'nowrap', lineHeight: 1.625 }}>Issued: <span className="font-bold text-[#0f172a] whitespace-nowrap font-sans pb-1" style={{ fontWeight: 700, color: '#0f172a', whiteSpace: 'nowrap' }}>{enrollmentDate}</span></span>
                </div>
              </div>
            </div>
