    ...
    <div className="sticky top-0 z-50 w-full px-3 pt-3 md:px-8 md:pt-6 pointer-events-none">
      <header className="max-w-6xl mx-auto bg-white/70 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.05)] py-2.5 px-4 md:py-3 md:px-6 rounded-[20px] md:rounded-[24px] flex items-center justify-between pointer-events-auto transition-all duration-300">
        ...
        <nav className="flex items-center gap-3 md:gap-6">
          ...
          {user ? (
            <div className="flex items-center gap-2 bg-apple-gray text-apple-text px-4 py-1.5 rounded-full text-sm font-medium shadow-sm transition-all duration-300">
            ...
            <a 
              href="/user/login" 
              className="flex items-center gap-2 bg-apple-text text-white px-4 py-1.5 rounded-full text-sm font-medium hover:bg-apple-text/90 transition-all duration-300 shadow-sm shadow-apple-text/10"
            >
